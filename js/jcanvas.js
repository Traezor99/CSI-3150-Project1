...
(function (jQuery, global, factory) {
    ...
    function ($, window) {
            ...
            if ($canvases.length !== 0) {
                ...
                if (layerId && layerId.layer) {
                    ...
                    for (l = 0; l < layers.length; l += 1) {
                        ...
                        if (
                            isString(layers[l].name) &&
                            layers[l].name.match(layerId)
                        ) {
                            layer = layers[l];
                            break;
                        }
        ...
        $.fn.removeLayerFromGroup = function removeLayerFromGroup(
            layerId,
            groupName
        ) {
            var $canvases = this,
        ...
        function _layerCanFireEvent(layer, eventType) {
            ...
            return (
                !layer.disableEvents &&
                (!layer.intangible ||
                    $.inArray(eventType, tangibleEvents) === -1)
            );
        }
                    ...
                    if (layer) {
                        ...
                        if (layer._event && layer.intersects) {
                            ...
                            if (
                                ...
                                data.originalRedrawOnMousemove =
        ...
        function _addLayer(canvas, params, args, method) {
            ...
            if (params.layer && !params._layer) {
                ...
                if (
                    layer.name === null ||
                    (isString(layer.name) &&
                        data.layer.names[layer.name] === undefined)
                ) {
            ...
            for (propName in endValues) {
                if (Object.prototype.hasOwnProperty.call(endValues, propName)) {
                    ...
                    if (isFunction(propValue)) {
                        ...
                        endValues[propName] = propValue.call(
                            canvas,
                            layer,
                            propName
                        );
                        ...
                        for (subPropName in propValue) {
                            if (
                                ...
                                if (layer[propName] !== undefined) {
                                    ...
                                    endValues[propName + "." + subPropName] =
                                        subPropValue;
                                }
                            }
                        }
	...
	*/
                    ...
                    if (params.visible) {
                        ...
                        for (i = 0; i < params.sides; i += 1) {
                            ...
                            if (params.concavity) {
                                ...
                                x =
                                    params.x +
                                    (apothem + -apothem * params.concavity) *
                                        cos(theta + hdtheta);
                                y =
                                    params.y +
                                    (apothem + -apothem * params.concavity) *
        ...
        function _addArrow(canvas, ctx, params, path, x1, y1, x2, y2) {
            ...
            if (path.arrowRadius && !params.closed) {
                ...
                leftX =
                    x2 + path.arrowRadius * cos(angle + path.arrowAngle / 2);
                leftY =
                    y2 + path.arrowRadius * sin(angle + path.arrowAngle / 2);
        ...
        function _measureText(canvas, ctx, params, lines) {
            ...
            if (
                ...
                params.height =
                    parseFloat($.css(canvas, "fontSize")) *
                    lines.length *
                    params.lineHeight;
                    ...
                    if (params.visible) {
                        ...
                        if (params.radius) {
                            ...
                            for (l = 0; l < lines.length; l += 1) {
                                ...
                                params.letterSpacing +=
                                    fontSize / (constantCloseness * 2 * PI);
                                ctx.restore();
                            }
                        } else {
